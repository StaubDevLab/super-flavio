...
export default function HeaderNavigation() {
    ...
    return <nav aria-label="Navigation principale" className="hidden lg:flex items-center gap-5 text-sm">
        {[["/", "Accueil"], ["/services", "Les services"], ["/realisations", "Réalisations"], ["/contact", "Contact"]].map(([href, label]) =>
